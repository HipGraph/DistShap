...
def get_sampler(nplayers: int, nsamples: int = None,
                sampler_name: str = "GNNShapSampler",
    ...
    Args:
        ...
        sampler_name (str, optional): sampler name. Defaults to "GNNShapSampler".
    ...
    try:
        return samplers[sampler_name](nplayers=nplayers, nsamples=nsamples,
                                      **kwargs)
    except KeyError:
