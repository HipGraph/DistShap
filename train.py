# Train models and save the model. The model will be saved in the pretrained
# folder. Can't train large models with this script. Use train_large.py instead.
# Large models are trained with NeighborLoader, which is not supported in this
# script.
...
pretrained_file = (f'{config["root_path"]}/pretrained/'
                   f'{args.dataset}_pretrained.pt')
...
model, data, config = get_model_data_config(args.dataset, load_pretrained=False,
